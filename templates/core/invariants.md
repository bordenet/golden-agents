...
| `.ai-guidance/*.md` | 50 lines | Split into sub-directory |
...
2. Extract to sub-files (≤50 lines each) → Update loading table
3. Verify: `wc -l Agents.md` ≤150

**Sub-file → sub-directory** (e.g., `testing.md` exceeds 50 lines):
