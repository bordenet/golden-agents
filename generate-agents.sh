...
OPTIONS
    ...
    --progressive       Generate minimal core (~60 lines) with on-demand loading (recommended)
    --compact           Generate compact version (~130 lines), inlined but condensed
...
upgrade_agents_md() {
    ...
    elif grep -q "(compact)" "$existing_file"; then
